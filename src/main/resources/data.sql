...
/*INSERT into users values ('user1','{bcrypt}$2a$10$RrWOUpSsr0Lc6LvRXMFjnufBwfZMKyNtO08pCQf67bctm//m7Zkwm',true,'deneme@deneme.com' );
INSERT into users values ('user2','{bcrypt}$2a$10$reprOQDwwZxaAhzrfNplP.nCTb/ncFcO/vUA4/H.QYnHst9zKSFK.',true,'deneme@deneme.com' );
INSERT into users values ('user3','{bcrypt}$2a$10$/gdMuZ31FXJ1WxsaSP4EwOKcn5VydUAHxiuKpE2jot4CVT.d22bI2',true ,'deneme@deneme.com');
INSERT into users values ('manager','{bcrypt}$2a$10$VKJZJVDnEBDIR2uijeQt4.BhD3drrR2DCxv9eRpBPApOOweNy3NtO',true,'deneme@deneme.com' );*/
